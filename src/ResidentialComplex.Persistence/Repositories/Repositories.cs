...
public class BillRepository : IBillRepository
{
    ...
    public async Task<List<Bill>> GetByMonthYearAsync(int year, int month) => await _db.Bills.Include(b => b.BillItems).Include(b => b.House).Where(b => b.Year == year && b.Month == month).ToListAsync();
